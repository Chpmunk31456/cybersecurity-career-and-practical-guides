# Rutas de carreras tecnológicas
...
9. [Analista de Riesgos y Cumplimiento de IA](ai-risk-compliance-analyst.md)
10. [Gerente de Producto de IA](ai-product-manager.md)
11. [Consultor/a de Adopción de IA](ai-adoption-consultant.md)
12. [Ingeniero/a de Visión por Computadora](computer-vision-engineer.md)
13. [Ingeniero/a de Procesamiento del Lenguaje Natural](natural-language-processing-engineer.md)

## Ciberseguridad

14. [Analista de Ciberseguridad](cybersecurity-analyst.md)
...
Estas guías apoyan la educación y la exploración profesional. No garantizan empleo, salario, admisión, certificación ni una trayectoria única. Verifique información cambiante mediante fuentes oficiales y proteja siempre su privacidad, seguridad y bienestar.

## Autoría y asistencia de IA

Creado y dirigido por **Alberto “Al” Leiva**. ChatGPT apoyó la investigación, organización, edición, traducción y preparación documental bajo la dirección del autor. El autor conserva la responsabilidad por las decisiones editoriales y de publicación.

## Licencia

Salvo indicación distinta, el contenido original se publica bajo la licencia [Creative Commons Atribución-NoComercial-CompartirIgual 4.0 Internacional](../../../../LICENSE).